...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        ...
        {
            // ASCII art banner - generated by pyfiglet standard (tight) + small
            var banner = new[]
            {
                "",
                " ____            ____                 _",
                "/ ___|  ___  ___|  _ \\ __ _ _ __   __| | ___  _ __ ___",
                "\\___ \\ / _ \\/ __| |_) / _` | '_ \\ / _` |/ _ \\| '_ ` _ \\",
                " ___) |  __/ (__|  _ < (_| | | | | (_| | (_) | | | | | |",
                "|____/ \\___|\\___|_| \\_\\__,_|_| |_|\\__,_|\\___/|_| |_| |_|",
                "",
                "__   __   _____    _ ",
                "\\ \\ / /__|_  / |_ (_)",
                " \\ V / -_)/ /| ' \\| |",
        ...
        // Windows 7's legacy console does not decode ANSI colour escapes, so colour the
        // phrase with Console.ForegroundColor instead. Added directly to the left edge.
        // Guard against environments where the console handle cannot change colour (it
        // must never abort startup just because this decoration failed); fall back to
        // plain output when colour is unavailable.
        try
        {
        ...
        try
        {
            Console.WriteLine("*  当太阳升起时，就把昨天忘掉  *");
        }
        finally
        {
