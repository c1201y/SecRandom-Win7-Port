...
Full Changelog: [v1.1.0.1...v1.1.2.0-beta](https://github.com/SECTL/SecRandom/compare/v1.1.0.1...v1.1.2.0-beta)
...
| --- | --- | --- | --- |
| ghfast.top | Windows | x86 | [下载 v1.1.2.0-beta](https://ghfast.top/https://github.com/SECTL/SecRandom/releases/download/v1.1.2.0-beta/SecRandom-Windows-v1.1.2.0-beta-x86.zip) |
| ghfast.top | Windows | x64 | [下载 v1.1.2.0-beta](https://ghfast.top/https://github.com/SECTL/SecRandom/releases/download/v1.1.2.0-beta/SecRandom-Windows-v1.1.2.0-beta-x64.zip) |
| gh-proxy.com | Windows | x86 | [下载 v1.1.2.0-beta](https://gh-proxy.com/https://github.com/SECTL/SecRandom/releases/download/v1.1.2.0-beta/SecRandom-Windows-v1.1.2.0-beta-x86.zip) |
| gh-proxy.com | Windows | x64 | [下载 v1.1.2.0-beta](https://gh-proxy.com/https://github.com/SECTL/SecRandom/releases/download/v1.1.2.0-beta/SecRandom-Windows-v1.1.2.0-beta-x64.zip) |

**SHA256 校验值-由于重新上传了二次修改版，所以去除了本次的校验值**
