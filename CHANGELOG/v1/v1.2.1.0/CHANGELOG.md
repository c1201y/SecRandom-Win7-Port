...
Full Changelog: [v1.2.0.0...v1.2.1.0](https://github.com/SECTL/SecRandom/compare/v1.2.0.0...v1.2.1.0)
...
| --- | --- | --- | --- |
| ghfast.top | Windows 目录模式 | x86 | [下载 v1.2.1.0](https://ghfast.top/https://github.com/SECTL/SecRandom/releases/download/v1.2.1.0/SecRandom-Windows-v1.2.1.0-x86-dir.zip) |
| ghfast.top | Windows 目录模式 | x64 | [下载 v1.2.1.0](https://ghfast.top/https://github.com/SECTL/SecRandom/releases/download/v1.2.1.0/SecRandom-Windows-v1.2.1.0-x64-dir.zip) |
| gh-proxy.com | Windows 目录模式 | x86 | [下载 v1.2.1.0](https://gh-proxy.com/https://github.com/SECTL/SecRandom/releases/download/v1.2.1.0/SecRandom-Windows-v1.2.1.0-x86-dir.zip) |
| gh-proxy.com | Windows 目录模式 | x64 | [下载 v1.2.1.0](https://gh-proxy.com/https://github.com/SECTL/SecRandom/releases/download/v1.2.1.0/SecRandom-Windows-v1.2.1.0-x64-dir.zip) |

**SHA256 校验值-请核对下载的文件的SHA256值是否正确**
| 文件名 | SHA256 值 |
| --- | --- |
|  |  |
| SecRandom-Windows-v1.2.1.0-x64-dir.zip | ffab5e3279a245b0e8c4a6744b833e511d2ec0d5094084b8162c8c6bdbf64d2d |
| SecRandom-Windows-v1.2.1.0-x86-dir.zip | 32d27fbc1cb3bbe733ef3ebb653c98afe556e5565a2732301c802fbf22962ab2 |
