...
Full Changelog: [v1.2.5.6...v1.2.6.22-beta](https://github.com/SECTL/SecRandom/compare/v1.2.5.6...v1.2.6.22-beta)
...
| --- | --- | --- | --- |
| ghfast.top | Windows 目录模式 | x64 | [下载 v1.2.6.22-beta](https://ghfast.top/https://github.com/SECTL/SecRandom/releases/download/v1.2.6.22-beta/SecRandom-Windows-v1.2.6.22-beta-x64-dir.zip) |
| gh-proxy.com | Windows 目录模式 | x64 | [下载 v1.2.6.22-beta](https://gh-proxy.com/https://github.com/SECTL/SecRandom/releases/download/v1.2.6.22-beta/SecRandom-Windows-v1.2.6.22-beta-x64-dir.zip) |
...
| SecRandom-Windows-v1.2.6.22-beta-x64-dir.zip | 4dd61aea3b4bc37b72cc91a8ceb4cd6e1800c2052d1137f3a2318eb5dee02710 |
