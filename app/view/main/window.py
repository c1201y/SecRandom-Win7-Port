...
from PySide2.QtCore import QTimer, QEvent, Signal, QThreadPool, QRunnable, Qt
...
class MainWindow(FluentWindow):
    ...
    def _check_and_run_auto_backup(self):
        ...
        from app.core.utils import FunctionRunnable
        QThreadPool.globalInstance().start(FunctionRunnable(task))
